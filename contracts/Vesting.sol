...
contract Vesting is Ownable {
    ...
    constructor(
        ...
        require(
            ...
            "Vesting/constructor: invalid ratio"
        );
        ...
        require(
            ...
            "Vesting/constructor: null array"
        );
        require(
            _accounts.length == _limitAmount.length,
            "Vesting/constructor: not equal array"
        );

        for (uint256 i = 0; i < _accounts.length; i++) {
            require(
                _limitAmount[i] > 0,
                "Vesting/constructor: invalid limitAmount"
            );
            require(
                addressToUserDetail[_accounts[i]].buyLimit == 0,
                "Vesting/constructor: user is already add"
            );
    ...
    function withdraw() external onlyOwner {
        require(
            ...
            "Vesting/withdraw: not enough to withdraw"
        );
